...
(function (KIP) {
    ...
    function createElement(obj) {
        ...
        if (obj.eventListeners) {
            map(obj.eventListeners, function (listener, key) {
     ...
     * getNextKey
     * ...........................................................................
     * Grab the next keyed element in an object. This is terribly unperformant in
...
(function (KIP) {
    ...
    (function (Styles) {
        ...
        var Stylable = (function (_super) {
             ...
             *
             * @param   themes  Sets of themes that should be merged together
             *
            ...
            Stylable.prototype._cleanStyles = function (styles, lastSelector) {
                ...
                KIP.map(styles, function (value, selector) {
                    ...
                    if (lastSelector) {
                        if (selector[0] === "&") {
                            newSelector = lastSelector + KIP.rest(selector, 1);
                        }
                        else {
                            newSelector = lastSelector + " " + selector;
                        }
                    }
                    var calculatedStyles = _this._cleanClassDef(newSelector, value);
                    outStyles = _this._mergeThemes(outStyles, calculatedStyles);
                });
                return outStyles;
            };
            /**...........................................................................
             ...
             * ...........................................................................
             */
            Stylable.prototype._cleanClassDef = function (selector, classDef) {
                var _this = this;
                var topStyles = {};
                topStyles[selector] = {};
                KIP.map(classDef, function (propertyValue, propertyName) {
                    ...
                    if (propertyName === "nested") {
                        ...
                        topStyles = _this._mergeThemes(topStyles, subnestedStyles);
                    }
                    else {
...
(function (KIP) {
     ...
     * ...........................................................................
     */
    var SimpleDrawable = (function (_super) {
...
(function (KIP) {
     ...
     * ...........................................................................
     */
    var ExistingDraggable = (function (_super) {
...
(function (KIP) {
    ...
    ;
    var YesNoPopup = (function (_super) {
...
var KIP;
(function (KIP) {
    var ToastPopup = (function (_super) {
...
var KIP;
(function (KIP) {
    var UnitTestUI = (function (_super) {
...
(function (KIP) {
     ...
     * ...........................................................................
     */
    var DynamicSelect = (function (_super) {
        ...
        DynamicSelect.prototype._expandDrawer = function () {
            ...
            KIP.transition(this._elems.drawer, { height: "0", opacity: "0" }, { height: "<height>", opacity: "1" }, 500);
        };
        /**...........................................................................
         * _collapseDrawer
         * ...........................................................................
        ...
        DynamicSelect.prototype._collapseDrawer = function () {
            var _this = this;
            KIP.transition(this._elems.drawer, { height: "<height>", opacity: "1" }, { height: "0", opacity: "0" }, 500).then(function () {
        ...
        DynamicSelect.prototype.addOption = function (opt) {
            var option = new DynamicOption(opt);
            this._availableOptions.addElement(option.id, option);
         ...
         * @param e
         */
        DynamicSelect.prototype._onClick = function (e) {
        };
        //#endregion
     ...
     * ...........................................................................
     */
    var DynamicOption = (function (_super) {
        ...
        DynamicOption.prototype.tryFilter = function (words) {
            var _this = this;
            return new KIP.KipPromise(function () {
                window.setTimeout(function () {
                    var word;
                    var notFound = false;
...
(function (KIP) {
     ...
     * ...........................................................................
     */
    var HTML5Canvas = (function (_super) {
...
(function (KIP) {
     ...
     * ...........................................................................
     */
    var LoadingShield = (function (_super) {
...
(function (KIP) {
    ...
    (function (Old) {
         ...
         */
        var ProjectWindow = (function (_super) {
            ...
            function ProjectWindow(name, start, dim) {
                ...
                KIP.SVGDrawable.call(_this, _this.id, "", { aspect: "none", zoomY: false });
